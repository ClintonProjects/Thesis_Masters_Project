/*!
 * react-paypal-js v7.4.2 (2021-10-15T16:22:37.141Z)
...
function generateErrorMessage(_a) {
    ...
    var errorMessage = "Unable to render <" + reactComponentName + " /> because window." + sdkDataNamespace + "." + requiredOptionCapitalized + " is undefined.";
    ...
    if (!sdkRequestedComponents.includes(sdkComponentKey)) {
        var expectedComponents = [sdkRequestedComponents, sdkComponentKey]
            .filter(Boolean)
            .join();
        errorMessage +=
...
var PayPalHostedFieldsProvider = function (_a) {
    ...
    React.useEffect(function () {
        ...
        (_b = hostedFields.current) !== null && _b !== void 0 ? _b : (hostedFields.current = getPayPalWindowNamespace$1(options[DATA_NAMESPACE]).HostedFields);
